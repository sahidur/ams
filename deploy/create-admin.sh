...
(async () => {
    try {
        ...
        if (existing.rows.length > 0) {
            ...
            await pool.query(
                'UPDATE users SET name = \$1, password = \$2, role = \$3, "approvalStatus" = \$4 WHERE email = \$5',
            ...
            // Create new user
            await pool.query(
                'INSERT INTO users (id, name, email, password, pin, role, "approvalStatus", "createdAt", "updatedAt") VALUES (gen_random_uuid(), \$1, \$2, \$3, \$4, \$5, \$6, NOW(), NOW())',
